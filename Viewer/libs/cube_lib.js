...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/cube_lib.data';
      var REMOTE_PACKAGE_BASE = 'cube_lib.data';
...
Module['FS_createPath']("/data", "tables", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/cube_lib.data');

      };
      Module['addRunDependency']('datafile_bin/cube_lib.data');
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'cube_lib.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('cube_lib.wasm', import.meta.url).toString();
}
