...
export class Scene {
    ...
    expandSceneBoundingBox(obj) {
        ...
        const TG = obj.ModelTransform;
        // Convert min and max to World Space:
        p_max.multVecMatrix(TG);
        p_min.multVecMatrix(TG);
        this.boundingBox.expand(Vec3.fromArray(p_max.getAsArray()));
        this.boundingBox.expand(Vec3.fromArray(p_min.getAsArray()));
    }
}
